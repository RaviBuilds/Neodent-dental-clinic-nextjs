    ...
    <section ref={sectionRef} className={`${styles.section} ${visible ? styles.visible : ""}`} id="leadership" aria-labelledby="leadership-title">
      ...
      <div className={styles.container}>
        ...
        <div className={styles.team}>
          ...
          <article className={`${styles.member} ${styles.medium}`}><div className={styles.memberImage}><img src="/assets/Dr. Md. Muti Ur Rahman - Neodent Dental Hospital.jpg" alt="Dr. Md. Muti Ur Rahman" /></div><span>02 / NeoDent team</span><h3>Dr. Md. Muti<br />Ur Rahman</h3><p>MBBS (OSM) · MD (Gen. Med.)<br />5+ years</p></article>
